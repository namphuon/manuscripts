...
%\footnote{Corresponding co-authors; Email: pmischel@ucsd.edu, vbafna@eng.ucsd.edu}
}
...
\bibliographystyle{NAR-natbib} % Style BST file (bmc-mathphys, vancouver, spbasic).
...
\begin{figure}[htpb]
  ...
  %\includegraphics[width= 6in]{{results/nguyen_figure1}.pdf}
...
\begin{figure}[htpb]
  \centering
  %\includegraphics[width=1\linewidth]{results/nguyen_figure2.pdf}\\
...
\end{figure}
 ...
 \begin{figure}[htpb]
  \centering
  %\includegraphics[width=0.90\linewidth]{results/nguyen_figure3.pdf}
...
\begin{figure}[htpb]
  \centering
  %\includegraphics[width=6in]{results/nguyen_figure4.pdf}\\
...
\begin{figure}[htpb] \centering
  %\includegraphics[width=6in]{{results/nguyen_figure5}.pdf}
...
\begin{figure}[htpb] \centering
    %\includegraphics[width=6.1in]{{results/nguyen_figure6}.pdf}
...
\begin{figure}[htpb]
  \centering
  %\includegraphics[width=5in]{{results/nguyen_figure7}.pdf}
